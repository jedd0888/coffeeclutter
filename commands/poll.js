...
module.exports.run = async (bot, message, args) => {
    ...
    if (!text) return message.channel.send("you need to set the title of the poll")//If he doesn't specify a text it will stop and tell him to type a text for the poll
    ...
    pollmessage.react("👎")
    message.channel.send("<@&713537414660096112>")
}
